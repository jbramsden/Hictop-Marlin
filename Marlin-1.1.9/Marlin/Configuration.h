...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_BASE  //Hictop(BOARD_RAMPS_13_EEB)
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Hictop E3D Chimera"
...
// :[1, 2, 3, 4, 5]
#define EXTRUDERS 2 //Hictop(1) E3D Chimera
...
#define TEMP_SENSOR_1 5 // Hictop(3) E3D Chimera
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -10  // Hictop X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -10  // Hictop Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.5   // Hictop Z offset: -below +above  [the nozzle]
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_ROUNOUT_PIN  11 //Hictop+BNV
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 10 // Hictop
  #define RIGHT_PROBE_BED_POSITION 175 // Hictop
  #define FRONT_PROBE_BED_POSITION 10 // Hictop
